...
public class PluginCallback implements Handler.Callback {
     ...
     * 一般情况下，mH 不会设置这个字段，也就是为null
     */
    private Handler.Callback mBase = null;
    ...
    public PluginCallback(Handler.Callback mBase) {
        this.mBase = mBase;
    }
    ...
    public boolean handleMessage(Message msg) {
        ...
        if(mBase != null)
            return mBase.handleMessage(msg);
        return false;
    }
    ...
    private boolean handleLaunchActivity(Message msg){
        DLog.i(TAG,"[-- my handlaunchactivity ---]");
        return false;
    }
